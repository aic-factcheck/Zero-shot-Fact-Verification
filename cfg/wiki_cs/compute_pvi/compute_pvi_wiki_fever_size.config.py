...
def config():
    ...
    MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_cs_CZ-20230801_fever_size_lr1e-6/checkpoint-98272")
    NULL_MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_cs_CZ-20230801_fever_size_lr1e-6_zero_input/checkpoint-32")
    MAX_LENGTH = 512
