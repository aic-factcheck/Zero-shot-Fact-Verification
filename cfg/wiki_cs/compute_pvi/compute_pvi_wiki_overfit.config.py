...
def config():
    ...
    NULL_MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_cs_CZ-20230801_balanced_lr1e-6_zero_input/checkpoint-36320")
    MAX_LENGTH = 512

    DATESTR = datetime.now().strftime("%y%m%d_%H%M%S")
    NOTE = f"Computes PVI on Wiki-CS test split and save its extended version. QACG-CS overfitted model."
