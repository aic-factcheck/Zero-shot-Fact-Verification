...
def config():
    ...
    MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_cs_CZ-20230801_balanced_lr1e-6/checkpoint-205760_calibrated")
    NULL_MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_cs_CZ-20230801_balanced_lr1e-6_zero_input/checkpoint-8992_calibrated")
    MAX_LENGTH = 512
