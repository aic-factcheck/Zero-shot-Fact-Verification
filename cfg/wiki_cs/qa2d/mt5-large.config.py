...
def config():
    ...
    MODEL_NAME = f"/home/drchajan/devel/python/FC/Zero-shot-Fact-Verification/experiments/qa2d/google/mt5-large_{LANG}/checkpoint-76000"
    MODEL_SHORT = "mt5-large_cp76k"
