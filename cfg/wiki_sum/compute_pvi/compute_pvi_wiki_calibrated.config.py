...
def config():
    ...
    MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_sum_cs_en_pl_sk-20230801_balanced_lr1e-6/checkpoint-321184_calibrated")
    NULL_MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_sum_cs_en_pl_sk-20230801_balanced_lr1e-6_zero_input/checkpoint-928_calibrated")
    MAX_LENGTH = 512
