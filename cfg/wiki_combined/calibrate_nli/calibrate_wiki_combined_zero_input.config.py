...
def config():
    ...
    MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_cs_en_pl_sk-20230801_balanced_lr1e-6_zero_input/checkpoint-32")
    MAX_LENGTH = 512

    DATESTR = datetime.now().strftime("%y%m%d_%H%M%S")
    NOTE = f"Calibrates combined language NLI model."
