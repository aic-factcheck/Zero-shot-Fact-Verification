...
def config():
    ...
    MODEL_NAME = f"/mnt/personal/drchajan/devel/python/FC/Zero-shot-Fact-Verification/experiments/qa2d/google/umt5-base_all"
    MODEL_SHORT = "umt5-base_all"

    CLAIM_ROOT = Path(QACG_ROOT, "claim", NER_DIR, QG_DIR, MODEL_SHORT)
    CLAIM_TYPES = ["support", "refute", "nei"]

    DATESTR = datetime.now().strftime("%y%m%d_%H%M%S")
    NOTE = f"Generates Wiki-EN claims."
