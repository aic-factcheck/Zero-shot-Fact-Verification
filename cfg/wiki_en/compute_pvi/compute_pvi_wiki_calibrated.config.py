...
def config():
    ...
    MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_en_US-20230801_balanced_lr1e-6/checkpoint-143264_calibrated")
    NULL_MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_en_US-20230801_balanced_lr1e-6_zero_input/checkpoint-8992_calibrated")
    MAX_LENGTH = 512

    DATESTR = datetime.now().strftime("%y%m%d_%H%M%S")
    NOTE = f"Computes PVI on Wiki-EN test split and save its extended version. QACG-EN model."
