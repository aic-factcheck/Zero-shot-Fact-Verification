...
def config():
    ...
    MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_en_US-20230801_fever_size_lr1e-6/checkpoint-87744_calibrated")
    NULL_MODEL_NAME = Path(MODEL_ROOT, "deepset/xlm-roberta-large-squad2_en_US-20230801_fever_size_lr1e-6_zero_input/checkpoint-32_calibrated")
    MAX_LENGTH = 512
